...
layout = dbc.Container(
    [
        ...
        ], className = 'secondary fs-5'),

        html.P([
            "Let's explore a common use case of how web scraping can benefit businesses:",
        ], className = 'secondary fs-4'),
        
        html.Hr(className="my-2"),
        
        
        html.H2("Price Monitoring and Competitive Analysis", className="display-3 primary"),
        ...
        html.P([
            "Here's how it works:",
        ], className="lead display-3 primary"),
